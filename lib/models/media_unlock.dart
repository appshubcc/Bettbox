...
MediaCategory.streaming,
  ...
  /// Rendered size of the platform svg.
  ///
  /// Every asset in `assets/images/platforms` is a square 1024x1024 canvas with
  /// the artwork centered inside, so these must stay square: a non-square box
  /// would fit the whole square canvas into it and shrink the artwork.
